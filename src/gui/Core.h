...
class Mouse {
  public:
    ...
    Mouse() {
        int a;
        loop(a, 0, 256) button[a] = button2[a] = 0;
        mouseX = mouseY = mouseDX = mouseDY = 0;
    }
    void update() {
        mouseDX = mouseX - mouseX2;
        mouseX2 = mouseX;
        mouseDY = mouseY - mouseY2;
        mouseY2 = mouseY;
        int a;
        loop(a, 0, 256) button2[a] = button[a];
    }
};
////////////////////////////////////////////////////////////////////////////////
class ScreenA {

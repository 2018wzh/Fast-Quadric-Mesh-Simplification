...
void vec3f::random_init() { random_number = 3457734; }
...
bool lines_intersect ( vec3f line1[2] ,vec3f line2[2] , vec3f* intersection = NULL)
{
        ...
        if ( line1[0].x < line2[0].x )	if ( line1[0].x < line2[1].x )	if ( line1[1].x < line2[0].x
)	if ( line1[1].x < line2[1].x ) return false; if ( line1[0].x > line2[0].x )	if (
line1[0].x > line2[1].x )	if ( line1[1].x > line2[0].x )	if ( line1[1].x > line2[1].x )
return false; if ( line1[0].y > line2[0].y )	if ( line1[0].y > line2[1].y )	if ( line1[1].y >
line2[0].y )	if ( line1[1].y > line2[1].y ) return false; if ( line1[0].y < line2[0].y )	if (
line1[0].y < line2[1].y )	if ( line1[1].y < line2[0].y )	if ( line1[1].y < line2[1].y )
return false;
